module gk
   implicit none
contains
subroutine dqag_k2(f,a,b,eps,s,ier)
   implicit none
   ...
   integer::neval,limit,lenw,last,key
   ...
   s=0d0
   call dqag(f,a,b,epsabs,eps,key,s,abserr,neval,ier, &
        limit,lenw,last,iwork,work)
 
   deallocate(iwork,work)
   return
 end subroutine dqag_k2
 
 subroutine dqag_k6(f,a,b,eps,s,ier)
   implicit none
   double precision,intent(in)::a,b,eps
   double precision,intent(out)::s
   integer,intent(out)::ier
   ...
   deallocate(iwork,work)
   return
 end subroutine dqag_k6
 
 ! 2017/09/04 (yyyy/mm/dd) modified by sikino
